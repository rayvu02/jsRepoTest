...
function renderHelloContent(target) {
  ...
  const cards = [
    { title: "Car 1", body: "T1", gradient: "linear-gradient(90deg, #6a11cb, #2575fc)" },
    { title: "Car 2", body: "T2", gradient: "linear-gradient(90deg, #ff7a18, #af002d, #319197)" },
    { title: "Car 3", body: "T3", gradient: "linear-gradient(90deg, #00b09b, #96c93d)" },
    { title: "Car 4", body: "T4", gradient: "linear-gradient(90deg, #f7797d, #FBD786, #C6FFDD)" }
  ];
